...
#                 output_filename = f"estim1/estim1_{first_num}_{second_num}_{third_letter}_{noise_level}.npy"
...
# print(np.load('estim1/estim1_0_0_H_200.npy'))
# # Load the array from the file
# array = np.load('estim1/estim1_0_0_H_200.npy')

# # Print the size of the array
# print("Size of the array:", array.shape)
# print('-------------')
# print(np.load('estim1/estim1_0_0_H_1000.npy'))
# print('-------------')
# print(np.load('estim1/estim1_0_0_L_200.npy'))

array = np.load('estim1/estim1_0_0_L_200.npy')
print(array)
print("Size of the array:", array.shape)