...
# After running the script, you will have output files for different combinations.
...
# ground_truth_poses = np.load('gts/gt_0_0.npy')
# # Assuming the extra row is at the beginning of the ground truth data
# ground_truth_poses = ground_truth_poses[1:, :]
